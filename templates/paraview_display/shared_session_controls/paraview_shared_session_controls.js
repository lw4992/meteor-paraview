 ...
 */
var refreshIntervalId = null, templateInstance, isInitializing = false, userStatusHandle = null;
...
var thisUserCanShare = function thisUserCanShare() {
    ...
    if (!thisUser || !thisUser['sharing'] || thisUser['sharing']['status'] !== UserHelper.SharedState.INITIALIZED)
        return false;
    return true;
};
