...
PV.config = function config(options:iPVInitOpts, callback?:iPVCallback) {
...
PV.init = function init(options?:iPVInitOpts, callback?:iPVCallback) {
    if (options.viewportCSSId) PV.viewportCssId = options.viewportCSSId;
    if (options.backgroundSetting) PV.backgroundSetting = options.backgroundSetting;
    callback && callback(null, {success: true});
};
...
PV.addFilter = function addFilter(filterName:string, settings?:iPVFilterSetting[], callback?:iPVCallback) {
...
//    "name": "ScaleFactor"
//},
PV.modifyFilter = function modifyFilter(filterId:number, filterSettings:iPVFilterSetting[], callback?:iPVCallback) {
